...
const FRETBOARD_GENERATOR={
    ...
    createScale: function(elementId){
        this.fretboard.createHorizontalFrets($(elementId+"-table"), this.scaleinfo);
        this.fretboard.createVexTabScale($(elementId+"-vextab"), this.scaleinfo);
        return this;
    },
...
const FRETBOARD = {
    ...
    createVexTabScale: function(eleDiv, scaleInfo){
        const data = `
        ...
        const renderer = new VF.Renderer(eleDiv, VF.Renderer.Backends.SVG);
